...
export default function ProtectionStory() {
  ...
  return (
    <section className='relative pt-16 min-h-screen bg-zinc-950 text-white overflow-x-hidden '>
      <div ref={containerRef} className="font-sans selection:bg-white selection:text-black">
        {/* Intro Section */}
